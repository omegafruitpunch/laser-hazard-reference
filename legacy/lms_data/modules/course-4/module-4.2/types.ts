// Type definitions for Module 4.2: Florida & Georgia State Regulations
...
export interface LocalRequirementsMap {
  type: 'local_requirements_map';
  id: string;
  locations: LocalRequirement[];
}
